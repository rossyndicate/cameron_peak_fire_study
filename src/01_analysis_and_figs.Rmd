...
rm(order_table, most_recent_chem)
...
correlate_grab_sonde(sites = "all" , sensor_param = "FDOM", grab_param = "DOC", timestep = "1hour", matched_axes = FALSE)+ theme_bw(base_size = 18)
ggsave("data/figs_output/2023_figs/fdom_doc_corr.jpg", width = 16, height = 12, dpi = 300)
