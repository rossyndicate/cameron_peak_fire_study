...
scale_fill_gradient2(name="Watershed Burn Intensity",low="#56B4E9", mid="#F0E442", high="#D55E00", 
   ...
   geom_dotplot(aes(x=reorder(site_code,order,max),y=ChlA, middle=mean(ChlA)), fill = "black", color = "black", stackgroups = FALSE, binaxis = "y", method = "histodot",stackdir = "center", position = "dodge", binwidth = .3, dotsize = .5)+
