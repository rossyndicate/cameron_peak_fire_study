...
#boxplot function size 24

nutrient_boxplot_graph24 = function(nutrient){
  res_only_data%>%
    filter(label == nutrient)%>%
  ggplot() +
  geom_boxplot(aes(x=reorder(site_code,order,max),y=value, middle=mean(value), fill=Watershed_Level)) +
...
#Boxplot title base size 24
nutrient_boxplot_w_title_graph24 = function(nutrient){
  res_only_data%>%
    filter(label == nutrient)%>%
  ggplot() +
  geom_boxplot(aes(x=reorder(site_code,order,max),y=value, middle=mean(value), fill=Watershed_Level)) +
...
ggarrange(sc_timeline_title,no3_timeline,po4_timeline,so4_timeline,f_timeline,k_timeline, na_timeline, ca_timeline, cl_timeline,mg_timeline,   ncol=1, nrow=12)#, common.legend=T) 


ggsave('output/nutrient_timeline_test_sc_no3_po4_so4_f_k_na_ca_cl_mg.jpg', width = 16, height = 24)
...
no3_boxplot <-nutrient_boxplot_graph24( 'NO3 (mg/L)')
po4_boxplot <-nutrient_boxplot_graph24( 'PO4 (mg/L)')
so4_boxplot <-nutrient_boxplot_graph24( 'SO4 (mg/L)')
chla_boxplot <-nutrient_boxplot_graph24( 'Chl-a (mg/L)')
pH_boxplot <-nutrient_boxplot_graph24( 'pH')
tss_boxplot <-nutrient_boxplot_graph24( 'TSS')
na_boxplot <-nutrient_boxplot_graph24( 'Na (mg/L)')
nh4_boxplot <-nutrient_boxplot_graph24( 'NH4 (mg/L)')
k_boxplot <-nutrient_boxplot_graph24( 'K (mg/L)')
mg_boxplot <-nutrient_boxplot_graph24( 'Mg (mg/L)')
ca_boxplot <-nutrient_boxplot_graph24( 'Ca (mg/L)')
f_boxplot <-nutrient_boxplot_graph24( 'F (mg/L)')
cl_boxplot <-nutrient_boxplot_graph24( 'Cl (mg/L)')
sc_boxplot <- nutrient_boxplot_graph24('SC (uS/cm)')

no3_boxplot_title <- nutrient_boxplot_w_title_graph24('NO3 (mg/L)')
sc_boxplot_title <- nutrient_boxplot_w_title_graph24('SC (uS/cm)')


#boxplot fig 1

 ggarrange(sc_boxplot_title,no3_boxplot,po4_boxplot,so4_boxplot,k_boxplot, ncol=1, nrow=6)#, common.legend=T) 
 ggsave('output/nutrient_boxplot_SC_NO3_PO4_SO4_K.jpg', width = 12.5, height = 16)
...
all_sites_data_2022 <- Reservoir_Chemistry%>%
filter(Year == "2022")%>%
...
nutrient_timeline_all_sites_2022 = function(nutrient){
...
nutrient_timeline_all_sites_2022_w_title = function(nutrient){
