...
no3_boxplot <-nutrient_boxplot_graph( 'NO3 (mg/L)')
po4_boxplot <-nutrient_boxplot_graph( 'PO4 (mg/L)')
so4_boxplot <-nutrient_boxplot_graph( 'SO4 (mg/L)')
chla_boxplot <-nutrient_boxplot_graph( 'Chl-a (mg/L)')
pH_boxplot <-nutrient_boxplot_graph( 'pH')
tss_boxplot <-nutrient_boxplot_graph( 'TSS')
na_boxplot <-nutrient_boxplot_graph( 'Na (mg/L)')
nh4_boxplot <-nutrient_boxplot_graph( 'NH4 (mg/L)')
k_boxplot <-nutrient_boxplot_graph( 'K (mg/L)')
mg_boxplot <-nutrient_boxplot_graph( 'Mg (mg/L)')
ca_boxplot <-nutrient_boxplot_graph( 'Ca (mg/L)')
f_boxplot <-nutrient_boxplot_graph( 'F (mg/L)')
cl_boxplot <-nutrient_boxplot_graph( 'Cl (mg/L)')

no3_boxplot_title <- nutrient_boxplot_w_title_graph('NO3 (mg/L)')
sc_boxplot_title <- nutrient_boxplot_w_title_graph('SC (uS/cm)')
...
#Larger plot
ggarrange(no3_boxplot_title,sc_boxplot_title,po4_boxplot,so4_boxplot,k_boxplot,na_boxplot,mg_boxplot,ca_boxplot,f_boxplot,cl_boxplot, ncol=2, nrow=6)
ggsave('output/nutrient_boxplot_SC_NO3_SO4_Mg_F_PO4_K_Na_Ca_Cl.jpg', width = 30, height = 25)
