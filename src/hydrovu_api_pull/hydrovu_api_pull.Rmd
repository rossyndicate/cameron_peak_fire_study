...
source("src/paper_figs/api_pull/hv_getdata_id.R")
source("src/paper_figs/api_pull/hv_locations_all.R")
```
...
```{r}
creds = yaml::read_yaml("src/paper_figs/api_pull/credentials.yml")
...
#... or, manual selection of start/end time
 start <- as.POSIXct("2023-05-01 01:00:00 MDT")
 end <- Sys.time()
