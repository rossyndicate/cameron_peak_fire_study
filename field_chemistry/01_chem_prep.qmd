...
write.csv(reservoir_chemistry, 
          "data/field_chemistry/cleaned/prepped_reservoir_chemistry.csv")

write.csv(filter(reservoir_chemistry, location == "Mainstem"),
          "data/field_chemistry/cleaned/prepped_mainstem_chemistry.csv")
...
write_csv(reservoir_chemistry_concise, 
          "data/field_chemistry/cleaned/CPF_reservoir_chemistry_up_to_110122.csv")
