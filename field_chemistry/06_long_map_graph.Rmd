...
This document is to work on longitudinal plots and animations related to nutrients from Reservoirs / mainstem. 
This work could be extended to plot continous data at the same sites or extend into the lower network of sensors. 
...
### Get lines as flowlines
 ...
 I manually drew the flowlines for plots on google earth to reduce overlap between sites that feed into the same. 
 We should develop a workflow to combine NHD flowlines between points and make those the lines that ratio data lives on. 
...
### Create Datasets for plotting
 ...
 - get_ratios_2022: acquire data in correct format for specific nutrient
 - make_point_ratio_spatial: Create point dataset for nutrient
 - make_line_ratio_spatial_flowlines: Create line dataset for specific nutrient
